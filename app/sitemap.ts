...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const statisch = ["", "/te-koop", "/openhuizen", "/zoeker", "/blog", "/reviews", "/huusmeesters", "/fotografie", "/guest-experience", "/verkocht", "/contact", "/faq", "/plaatsen", "/registreren", "/inloggen", "/voorwaarden", "/privacy", "/cookies", "/disclaimer"];
