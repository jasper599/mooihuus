...
import { syncMarinaparken } from "@/lib/marinaparken-feed";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// Marinaparken-huurfeed synchroniseren. Beveiligd met CRON_SECRET (geplande
// taak) of een ingelogde beheerder.
// Aanroepen: GET /api/cron/marinaparken?key=CRON_SECRET
async function run(req: Request) {
  ...
  const res = await syncMarinaparken();
